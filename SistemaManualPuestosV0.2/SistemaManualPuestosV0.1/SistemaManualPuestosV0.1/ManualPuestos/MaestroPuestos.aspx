	...
	cbTest.PerformCallback();
                                    ...
                                    <EditFormLayoutProperties ColCount="3">
                                        <Items>
                                            ...
                                            <dx:GridViewColumnLayoutItem Caption="ID:" ColSpan="3" ColumnName="ID" Name="ID">
                                            </dx:GridViewColumnLayoutItem>
                                            <dx:GridViewLayoutGroup Caption="Datos de Identificacion" ColCount="4" ColSpan="3">
                                                <Items>
                                                    <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Denominación">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Titulo Requerido">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Area de Conocimiento">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Grado">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Nivel">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Interfaz del Puesto">
                                                    </dx:GridViewColumnLayoutItem>
                                                </Items>
                                            </dx:GridViewLayoutGroup>
                                            <dx:GridViewLayoutGroup Caption="Descripcion" ColCount="4" ColSpan="3" RowSpan="4">
                                                <Items>
                                                    <dx:GridViewColumnLayoutItem ColSpan="2" ColumnName="Misión">
                                                    </dx:GridViewColumnLayoutItem>
                                                </Items>
                                            </dx:GridViewLayoutGroup>
                                            <dx:GridViewLayoutGroup Caption="Instruccion Formal Requerida" ColCount="3" ColSpan="3">
                                                <Items>
                                                    <dx:GridViewColumnLayoutItem ColumnName="Nivel Instruccion">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColumnName="Nivel Intruccion 2">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColumnName="Nivel Instruccion 3">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColSpan="3" ColumnName="Area de Conocimiento">
                                                    </dx:GridViewColumnLayoutItem>
                                                </Items>
                                            </dx:GridViewLayoutGroup>
                                            <dx:GridViewLayoutGroup Caption="Experiencia Laboral" ColCount="3" ColSpan="3">
                                                <Items>
                                                    <dx:GridViewColumnLayoutItem ColumnName="Tiempo Experiencia">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColumnName="Tiempo Experiencia 2">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColumnName="Tiempo Experiencia 3">
                                                    </dx:GridViewColumnLayoutItem>
                                                    <dx:GridViewColumnLayoutItem ColSpan="3" ColumnName="Contenido Experiencia">
                                                    </dx:GridViewColumnLayoutItem>
                                                </Items>
                                            </dx:GridViewLayoutGroup>
                                            <dx:GridViewLayoutGroup Caption="Capacitacion" ColCount="3" ColSpan="3">
                                            </dx:GridViewLayoutGroup>
                                            <dx:EditModeCommandLayoutItem ColSpan="3">
                                            </dx:EditModeCommandLayoutItem>
                                        </Items>
