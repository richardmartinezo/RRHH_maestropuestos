...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	cbTest.PerformCallback();
                                            ...
                                            <dx:ASPxGridView ID="ASPxGridViewDetalleMaestros" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceDetalleMaestro" KeyFieldName="id" ClientInstanceName="ASPxGridViewDetalleMaestros" OnStartRowEditing="ASPxGridViewDetalleMaestros_StartRowEditing" OnCustomButtonCallback="ASPxGridViewDetalleMaestros_CustomButtonCallback" OnInitNewRow="ASPxGridViewDetalleMaestros_InitNewRow">
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataComboBoxColumn Caption="Competencias Tecnicas" FieldName="id_com_tecnica" VisibleIndex="10">
                                                        <PropertiesComboBox DataSourceID="SqlDataSourceCompetenciasConductuales" TextField="ccdetalle" ValueField="id">
                                                        </PropertiesComboBox>
                                                    </dx:GridViewDataComboBoxColumn>
                                                    <dx:GridViewDataComboBoxColumn FieldName="id_com_conductuales" VisibleIndex="14">
                                                        <PropertiesComboBox DataSourceID="SqlDataSourceCompetenciasConductuales" TextField="ccdetalle" ValueField="id">
                                                        </PropertiesComboBox>
                                                    </dx:GridViewDataComboBoxColumn>
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="titulo_requerido" VisibleIndex="13" Caption="Titulo Requerido"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="area_conocimiento" VisibleIndex="16" Caption="Area de Conocimiento"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="contenido_experiencia" VisibleIndex="18" Caption="Contenido Experiencia"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="puntos" VisibleIndex="19" Caption="Puntos" Visible="False"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="interfaz_puesto" VisibleIndex="20" Caption="Interfaz del Puesto" Visible="False"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="habilidad_gestion" VisibleIndex="21" Caption="Habilidad Gestión" Visible="False"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="observaciones" VisibleIndex="26" Caption="Observaciones"></dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="escala" VisibleIndex="27" Caption="Escala"></dx:GridViewDataTextColumn>
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="id_an_estudio" VisibleIndex="14" Caption="Años Estudio">
                                            <PropertiesComboBox DataSourceID="SqlDataSourceAnEstudio" TextField="anioestudio" ValueField="id">
                                            </PropertiesComboBox>
                                        </dx:GridViewDataComboBoxColumn>
                                        <dx:GridViewDataComboBoxColumn FieldName="id_an_estudio_post" VisibleIndex="15" Caption="Años Estudio Postgrado">
                                            <PropertiesComboBox DataSourceID="SqlDataSourceAnEstudioPost" TextField="anioestudio" ValueField="id">
                                            </PropertiesComboBox>
                                        </dx:GridViewDataComboBoxColumn>
                                        <dx:GridViewDataComboBoxColumn FieldName="id_hab_comunicacion" VisibleIndex="22" Caption="Habilidad Comunicación">
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="id_con_trabajo" VisibleIndex="23" Caption="Con Trabajo">
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="id_toma_decisiones" VisibleIndex="24" Caption="Toma Decisiones">
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="id_con_resultados" VisibleIndex="25" Caption="Con Resultados">
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="id_expecificacion_experiencia" Caption="Especificacion Experiencia" VisibleIndex="17">
                                        ...
                                        <dx:GridViewDataComboBoxColumn FieldName="id_tiempo_experiencia" Caption="Tiempo Experiencia" VisibleIndex="29">
